  ...
  async function sendEmailJSForm() {
    ...
    try {
      const result = await emailjs.sendForm(
        loaderData.ENV.SERVICEID,
        loaderData.ENV.TEMPLATEID,
        form.current,
        loaderData.ENV.PUBLICKEY
      )
  ...
  const verifyToken = async (token) => {
    try {
      ...
      let response = await axios.post(
        `http://129.213.56.124:3000/verify-token`,
        {
            ...
            {state.message === "Done" ? (
              ...
              <div className="contact-wrap">
                ...
                <Form
                  ...
                  ref={form}
                  aria-hidden={state.message === "success"}
                >
                  <div className="contact-row">
                    ...
                    <div className="form-group">
                      <input
                        ...
                        disabled={state.message === "Completed"}
                      />
                    </div>
                    <div className="form-group">
                      <ReCAPTCHA
                        sitekey={loaderData?.ENV?.CAPTCHAKEY}
                        ref={recaptchaRef}
                        name="captcha"
                        id="captcha"
                      />
                ...
                >
                  <p className={state?.class}>{state?.message}</p>
                </div>
