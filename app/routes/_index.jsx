...
import webImage from '../assets/painter.jpg'
...
export const meta = () => {
  return [{ title: "Hogtown Digital - Creating digital experiences | Web Design" }];
};
    ...
    <>
        ...
        <div className="wrapper">
          ...
          <div className="container">
            <Card heading="Website & App Development" img={Design} body="We build custom, high performance websites to meet your business needs with a focus on SEO, accessibility and site speed." />
            <Card heading="Data & Analytics" img={Hosting} body="From setting up Google Analytics and building out data pipelines to custom web scraping, we can help with all your data needs." />
            <Card heading="Digital Marketing" img={Analytics} body="Want to aquire leads through paid media but don't know where to start? We can help run your search, display and social campaigns with any budget." />
          </div>
        </div>
        <div className="wrapper">
          <TextBanner />
